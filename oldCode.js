...
This file is for whoever wants to see my progress in JavaScript. I kept
all the code I have written on this project.

This project took me about three weeks of long hours to make create. It 
is also the first JavaScript heavy project I have ever made. I made some 
breakthroughs with this project, it definitely was huge to my progress
and helped me achieve fluency in the language, as to this day, I can 
write in JavaScript as if it were a second language; it comes naturally.

Most of these weren't what I wanted, so I had to remove the code and start over
multiple times. My most recent one (code.js) is refactored using up to date JS
and only took me 4 hours one night to complete vs the 3 weeks of 10 hour days trying
to figure out how to get this to work.

One thing to note, is that I started with ES5 and then later started integrating 
ES6 into my work, as you can see there are lots of FOR loops and VAR everywhere.
...
*/
//                                                                  This is start of a new project
